"""
Django settings for contributions_dashboard project.
...
SECRET_KEY = 'django-insecure-v3%yud#$s*vq_xphk#d@09u9h1w1&@f(0e&g=#3u^0sj%y7c@2'
...
ROOT_URLCONF = 'contributions_dashboard.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [
            os.path.join(BASE_DIR, "contributions_dashboard", "templates"),
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'contributions_dashboard.wsgi.application'
...
STATICFILES_DIRS = [
    BASE_DIR / "contributions_dashboard" / "static",
]
